...
# The failure-rate-by-prompt figure (Failure_Rate_by_Batch) is generated by the
# standalone matplotlib script plot_failure_rate.py, which has no plotly/kaleido
# dependency and places each value label clear of the other series.


# The Think ON vs Think OFF figure (Think_OnOff_Comparison) is generated by the
# standalone matplotlib script plot_think_comparison.py, in the same style.
